...
<p>
  ...
  ```shell
  vsearch --usearch_global query_sequence.fasta --db sequences_vsearch.v1.0.fasta --id 0.9 --blast6out results.txt
  ```
  - usearch_global: Specifies the search mode for global alignment.
  - db path/sequences_vsearch.v1.0.fasta: Specifies the path to the database fasta file.
